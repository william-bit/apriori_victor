...
export default function Authenticated({ user, header, children }: PropsWithChildren<{ user: User, header?: ReactNode }>) {
    ...
    const listMenu = [
        ...
        { label: 'Data Transaction', href: route('data'), active: route().current('data') },
        { label: 'Config', href: route('config'), active: route().current('config') },
        { label: 'Master Product', href: route('product'), active: route().current('product') },
        { label: 'Recommendation', href: route('recommendation'), active: route().current('recommendation') },
        ...
        { label: 'Account', href: route('account'), active: route().current('account') },
    ]
    return (
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                {
                                    listMenu.map(value => (
                                        <NavLink key={value.label} href={value.href} active={value.active}>
                                            {value.label}
                                        </NavLink>
                                    ))
                                }
