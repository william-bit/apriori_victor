                ...
                <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                    <div className="overflow-hidden">
                        <table className="min-w-full text-center">
                                ...
                                <tr>
                                    ...
                                    </th>
                                    {
                                        props.header.map(header => (
                                            <th key={header["key-data"]} scope="col" className="px-6 py-4 text-sm font-medium text-white">
                                                {header['label']}
                                            </th>
                                        ))
                                    }
                            ...
                            <tbody>
                                {props.data.data.length == 0 && <tr className="bg-white border-b">
                                    <td
                                        colSpan={props.header.length + 1}
                                        className="px-6 py-4 text-sm font-medium text-gray-900 border even:bg-gray-50 whitespace-nowrap">
                                        No Data
                                    </td>
                                </tr>}
                                {
