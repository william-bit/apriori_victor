            ...
            <Island className="p-4 ">
                <div className="w-full">
                    ...
                    <form onSubmit={e => submit(e)} method="GET" className="flex flex-wrap h-full">
                        ...
                        <a href={route('data.destroy')} className="flex items-center justify-center px-5 py-1 mr-1 font-bold text-white bg-red-500 cursor-pointer whitespace-nowrap hover:bg-red-600">
                            <div> Clear Data</div>
                        </a>
                    </form>
                </div>
