        ...
        <tbody>
            @foreach ($data as $rank => $datum)
                <tr>
                    ...
                    @if ($datum->confidence < 33)
                        <td>Low</td>
                    @elseif ($datum->confidence < 66)
                        <td>Medium</td>
                    @else
                        <td>High</td>
                    @endif
                    <td>Jika orang beli barang {{ $datum->antecedentConcat }} maka akan membeli
                        {{ $datum->consequentConcat }} dengan presentase keakuratan sebesar
                        {{ $datum->confidence }} </td>
                    {{-- <td>{{ $datum->support }}</td>
